		...
		<div class="modal-dialog" style="width:490px;">
			...
			<div class="modal-content">		
				...
				<div class="modal-body" style="padding: 0 50px;">
					...
					?>
					<p>
					<a class="ord_hover" href="index.php?" style="text-decoration:none; font-size: 17px; width: 107px;display: block; height: 40px;text-align: center; padding-top: 5px; border-radius: 4px;outline:none;border: 2px solid #96D472;margin-top: 20px;background-color: #96D472;color: #fff" type="button" onclick="showAlert()" role="button">Order Now</a>
					</p>
				</div>
				<div class="modal-footer" style="border-top:none;">
					<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
				</div>
				<!--	<p><a href="order.php?package_id=<?php echo $package_id;?>" style="text-decoration:none;"><button type="button">Order Now</button></a></p> -->
			</div>
		</div>
