...
<html>
<head>
		<title>Admin Creat Package Page</title>
		<link href="../style.css" rel="stylesheet" type="text/css"/>
</head>
<body>  
       <div class="main">
		<h1>Online Food Order Creat Package Admin Page</h1>
		<div class="header">
			...
			<table>
				<tr>
					...
					<td><a  href="admin_package.php"><h1>All Package</h1></a></td><td></td>
					<td><a href="orderlist.php"><h1>Order</h1></a></td><td></td>
					<td><a href="../logout.php" type="button"><h1>Logout</h1></a></td>			
	        </tr>  
			</table>
            </div>
			</br>
